...
var game_levels: states.GameLevels;
...
var playerWins: states.PlayerWins;
var currentState;
/*---------------------------------------------------------------------------------------------------------*/
